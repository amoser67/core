...
class MTFraEng(d2l.DataModule):  #@save
    ...
    def _build_arrays(self, raw_text, src_vocab=None, tgt_vocab=None):
        # Modify each array so that its size = self.num_steps.
        # - For arrays shorter than num_steps, append <pad> characters to make up the difference.
        # - For arrays longer than num_steps, truncate them.
        # Additionally, return the true length of the sequence before modifications.
